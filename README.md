...
```bash
curl -fsSL https://raw.githubusercontent.com/arturbaumann/monvif/master/scripts/install.sh | bash
```
...
```bash
INSTALL_DIR=/usr/local/bin curl -fsSL https://raw.githubusercontent.com/arturbaumann/monvif/master/scripts/install.sh | bash
```
